"""
Django settings for anonymous_thought_board project.
"""
...
INSTALLED_APPS = [
    ...
    'thoughtify.apps.ThoughtifyConfig',
]
...
ROOT_URLCONF = 'anonymous_thought_board.urls'
...
WSGI_APPLICATION = 'anonymous_thought_board.wsgi.application'
